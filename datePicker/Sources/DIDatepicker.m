...
const CGFloat kDIDatepickerSpaceBetweenItems = 25.;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(DIDatepicker:didSelectToIndex:)]) {
        [self.delegate DIDatepicker:self didSelectToIndex:selectedIndexPath.row];
    }
    [self sendActionsForControlEvents:UIControlEventValueChanged];
}
